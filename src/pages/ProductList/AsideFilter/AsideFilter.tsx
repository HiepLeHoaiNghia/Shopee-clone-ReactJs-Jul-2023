    ...
    <div className='py-4'>
      ...
      <ul>
        {categories.map((categoryItem) => {
          ...
          return (
            <li className='py-2 pt-2' key={categoryItem._id}>
              <Link
                to={{
                  pathname: path.home,
                  search: createSearchParams({
      ...
      <Link to={path.home} className='mt-4 flex items-center font-bold uppercase'>
        <svg enableBackground='new 0 0 15 15' viewBox='0 0 15 15' x={0} y={0} className='mr-3 h-4 w-3 stroke-current'>
          <g>
            <polyline
              fill='none'
      ...
      <div className='my-5'>
        ...
        <form className='mt-2' onSubmit={onSubmit}>
          <div className='flex items-start'>
            ...
            />
            <div className='m-3 h-[1px] w-5 grow bg-gray-400' />
            <Controller
              control={control}
              name='price_max'
              render={({ field }) => {
